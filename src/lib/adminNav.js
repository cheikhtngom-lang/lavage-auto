...
export const ADMIN_NAV = [
  ...
  // Pompistes : stations d'essence qui font aussi du lavage — forfaits Pro et Business — voir
  // RequirePompistesAccess (App.jsx).
  { key: 'pompistes', name: 'Pompistes', href: '/admin/pompistes', icon: Fuel, perm: 'pompistes.manage', plans: ['Pro', 'Business'], hint: 'Pointage des pompistes, pompe affectée, litres vendus et montant encaissé.' },
